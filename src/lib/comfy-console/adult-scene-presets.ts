...
// Explicit preset packs only exist for NSFW levels 3–5 (20 curated scenes each).
// Levels 1–2 are SFW/boudoir territory handled by the SFW scene tooling, so
// selectAdultScenePreset() must return null for them.

...
const FLUX_PRESETS: Record<PromptSubject, FamilySubjectPreset> = {
  ...
  '2d': {
    ...
    descriptor: '2D anime illustration, clean line art, cel shading, expressive eyes, vibrant flat color',
    qualityPrefix: '',
    qualitySuffix: 'sharp clean lines, high detail anime key visual, no blur, no jpeg artifacts',
    negative: 'photograph, photorealistic, 3d render, blurry, soft focus, low quality, jpeg artifacts, dirty lines, watermark',
    nsfwNegativeExtra: '',
...
const PONY_PRESETS: Record<PromptSubject, FamilySubjectPreset> = {
  ...
  '2d': {
    ...
    descriptor: '1girl, solo, anime style, clean line art, cel shading',
    qualityPrefix: 'score_9, score_8_up, score_7_up',
    qualitySuffix: '',
    negative: 'score_1, score_2, bad anatomy, bad hands, blurry, low quality, watermark, photorealistic, 3d',
    nsfwNegativeExtra: 'censored, mosaic, bar censor',
    enhancers: { adetailer: true, upscale: true },
  },
  '3d': {
...
const ILLUSTRIOUS_PRESETS: Record<PromptSubject, FamilySubjectPreset> = {
  female: {
    ...
    descriptor: '1girl, solo, anime style, clean line art, cel shading, detailed eyes',
    qualityPrefix: 'masterpiece, best quality, very aesthetic, absurdres, highres',
    qualitySuffix: '',
    negative: 'worst quality, low quality, bad anatomy, bad hands, missing fingers, extra digits, blurry, jpeg artifacts, photorealistic, realistic, 3d, watermark, text, signature',
    nsfwNegativeExtra: 'censored, mosaic, bar censor',
    enhancers: { adetailer: true, upscale: true },
  },
  male: {
    note: 'Illustrious 二次元男性：1boy danbooru 协议。',
    descriptor: '1boy, solo, anime style, clean line art, cel shading',
    qualityPrefix: 'masterpiece, best quality, very aesthetic, absurdres, highres',
    qualitySuffix: '',
    negative: 'worst quality, low quality, 1girl, bad anatomy, bad hands, blurry, jpeg artifacts, photorealistic, 3d, watermark',
    nsfwNegativeExtra: 'censored, mosaic, bar censor',
    enhancers: { adetailer: true, upscale: true },
  },
  transgender: {
  ...
  '2d': {
    ...
    descriptor: '1girl, solo, anime style, clean line art, cel shading, vibrant color, detailed background',
    qualityPrefix: 'masterpiece, best quality, very aesthetic, absurdres, highres',
    qualitySuffix: '',
    negative: 'worst quality, low quality, bad anatomy, bad hands, blurry, jpeg artifacts, photorealistic, realistic, 3d, watermark, text',
    nsfwNegativeExtra: 'censored, mosaic, bar censor',
    enhancers: { adetailer: true, upscale: true },
  },
  '3d': {

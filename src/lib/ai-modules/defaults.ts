  ...
  return {
    ...
    endpoints: [
      ...
      },
      {
        ...
        min_tier: 'free',
        public_label: 'Wit',
        public_description: 'Smart and playful — sharper humor, richer detail and better roleplay.',
      },
      {
        id: 'runpod-qwen3-8b-pro-nsfw',
        label: 'RunPod Qwen3 8B Pro NSFW',
        provider: 'runpod',
        model_id: process.env.RUNPOD_PRO_CHAT_MODEL || 'Qwen3-8B-Pro-NSFW',
        api_base_url: null,
        ...
        credit_cost: 5,
        min_tier: 'pro',
        public_label: 'Passion',
        public_description: 'Uncensored intimate roleplay with no filters — fully unlocked desire. Pro members only.',
      },
      {
        id: 'runpod-qwen3-30b-roleplay',
        label: 'RunPod Qwen3 30B Unlimited',
        provider: 'runpod',
        model_id: process.env.RUNPOD_UNLIMITED_CHAT_MODEL || 'Qwen3-30B-Unlimited',
        api_base_url: null,
      ...
      },
      {
        ...
        min_tier: 'free',
        public_label: 'Muse',
        public_description: 'Deep memory and long storylines — remembers your history and keeps long roleplay arcs coherent.',
      },
      {
        ...
        min_tier: 'free',
        public_label: 'Swift',
        public_description: 'Fast, light everyday chat — quick replies for casual flirting and daily talk.',
      },
      {
      ...
      },
      {
        ...
        credit_cost: 10,
        min_tier: 'pro',
        public_label: 'Devotion',
        public_description: 'Premium uncensored storytelling — the most vivid and immersive adult experience. Pro members only.',
      },

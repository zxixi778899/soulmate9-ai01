    ...
    chat: {
      ...
      tiers: {
        ...
        pro: {
          ...
          fallback_endpoint_ids: ['openrouter-lumimaid-9b', 'together-gpt-oss-120b', 'together-qwen35-9b'], daily_cost_soft_limit_usd: 0.75,
          max_tokens: 1024,
          context_messages: 24,
        ...
        unlimited: {
          ...
          fallback_endpoint_ids: ['runpod-qwen35-9b-abliterated', 'openrouter-noromaid-20b', 'together-qwen3-235b', 'together-gpt-oss-120b'], daily_cost_soft_limit_usd: 2.5,
          max_tokens: 1536,
          context_messages: 40,

...
export function createDefaultAiModules(): AiModulesConfig {
  ...
  return {
    ...
    endpoints: [
      ...
      {
        id: 'openrouter-euryale-70b',
        label: 'OpenRouter Euryale 70B (NSFW Fallback)',
        provider: 'openrouter',
        ...
        timeout_ms: 30000,
        retry_count: 1,
        fallback_ids: ['openrouter-aion-rp-8b'],
        circuit_breaker: { failure_threshold: 3, reset_ms: 60000 },
        notes: 'Uncensored NSFW RP fallback when RunPod is down',
      },
      {
        id: 'openrouter-aion-rp-8b',
        label: 'OpenRouter Aion RP 8B (Low-Cost Fallback)',
        provider: 'openrouter',

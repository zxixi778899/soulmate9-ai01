...
- For character-art: the face is already locked by IP-Adapter, so the prompt must drive everything else. Write a natural-language description of this adult AI companion and the seductive, flirtatious or intimate action she is performing — her pose, body language, gaze, outfit and the mood of the scene, as if directing a sensual lifestyle or boudoir photograph. Let sensuality rise with NSFW level: 1=casual and approachable, 2=flirty and suggestive, 3=lingerie and revealing, 4=bold intimate posing, 5=explicit adult scene. Keep her whole body in frame from head to feet with margin above and below — a full-length key visual, never a close-up, never waist-up, never cropped legs. Cinematic magazine lighting, clean readable silhouette. This is the final promotional product.

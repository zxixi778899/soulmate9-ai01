    ...
    <>
        ...
        <div className="flex-1 flex flex-col lg:flex-row pt-16">
          ...
          <div className="lg:w-2/5 p-6 md:p-8 lg:p-10 overflow-y-auto">
            ...
            <p className="mt-4 text-sm text-[#a1a1aa] leading-relaxed">
              {girlfriend.short_description ||
                girlfriend?.character_card?.description ||
                'A unique AI companion waiting to meet you.'}
            </p>
            ...
            <div className="mt-8">
              ...
              <p className="mt-2 text-sm text-[#a1a1aa] leading-relaxed">
                {girlfriend.backstory ||
                  `${girlfriend.name} is a ${girlfriend.personality?.toLowerCase() || 'unique'} AI companion who loves deep conversations and meaningful connections.`}
              </p>
      ...
      <ShareCard
        girlfriend={{
          ...
          portrait_url: girlfriend.image_url,
        }}
        open={shareOpen}

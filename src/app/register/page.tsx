    ...
    <main className="flex min-h-screen flex-col items-center justify-center px-4 bg-[#07070F]">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center">
          ...
          <p className="text-sm text-white/40">Join SoulMate AI today</p>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div>
            <label className="block text-xs text-white/50 mb-1.5 font-heading">Username</label>
            <input
              type="text"
              value={username}
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <span className="text-xs text-white/40">
              I agree to the <a href="/terms" className="text-[#FF6BA6]">Terms</a> and <a href="/privacy" className="text-[#FF6BA6]">Privacy Policy</a>
            </span>
          </label>
          <button
            type="submit"
        ...
        <p className="text-center text-sm text-white/30">
          Have an account?{" "}
          <a href="/login" className="text-[#FF6BA6] hover:text-[#FF2D78] transition-colors">
            Sign in
          </a>
        </p>
      </div>

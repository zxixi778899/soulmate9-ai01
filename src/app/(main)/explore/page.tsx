...
const GIRLS: Girl[] = [
  { id: 'g1', name: 'Nova', tagline: 'Your favorite synthwave girlfriend. Soft on the outside, fire in the dark.', age: 23, avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=500&fit=crop', tags: ['mysterious', 'romantic', 'playful'], rarity: 'SSR', intimacy: 82, online: true, personality: 'mysterious·romantic·playful' },
  { id: 'g2', name: 'Luna', tagline: 'Mysterious dreamer who comes alive under starlight.', age: 24, avatar: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400&h=500&fit=crop', tags: ['poetic', 'gentle', 'tender'], rarity: 'SR', intimacy: 65, online: true, personality: 'poetic·gentle' },
  { id: 'g3', name: 'Sophie', tagline: 'Sweet artist next door, ready to paint your story.', age: 22, avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=500&fit=crop', tags: ['sweet', 'creative', 'flirty'], rarity: 'R', intimacy: 41, online: false, personality: 'sweet·creative' },
  { id: 'g4', name: 'Violet', tagline: 'Bold and powerful, knows exactly what she wants.', age: 26, avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&h=500&fit=crop', tags: ['bold', 'confident', 'passionate'], rarity: 'SSR', intimacy: 91, online: true, personality: 'bold·confident·passionate' },
  { id: 'g5', name: 'Maya', tagline: 'Gentle morning poet who finds beauty in small things.', age: 23, avatar: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&h=500&fit=crop', tags: ['gentle', 'wise', 'caring'], rarity: 'SR', intimacy: 58, online: true, personality: 'gentle·wise' },
  { id: 'g6', name: 'Aria', tagline: 'Flirty troublemaker with a wink that breaks hearts.', age: 21, avatar: 'https://images.unsplash.com/photo-1502823403499-6ccfcf4fb453?w=400&h=500&fit=crop', tags: ['flirty', 'playful', 'spicy'], rarity: 'R', intimacy: 33, online: true, personality: 'flirty·playful·spicy' },
  { id: 'g7', name: 'Ruby', tagline: 'Dominant queen. She runs the show, you obey.', age: 25, avatar: 'https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=400&h=500&fit=crop', tags: ['dominant', 'spicy', 'confident'], rarity: 'SSR', intimacy: 77, online: false, personality: 'dominant·spicy·confident' },
  { id: 'g8', name: 'Celeste', tagline: 'Elegant Parisian who teaches French and forbidden things.', age: 27, avatar: 'https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=400&h=500&fit=crop', tags: ['elegant', 'sophisticated', 'mature'], rarity: 'SR', intimacy: 49, online: true, personality: 'elegant·sophisticated' },
  { id: 'g9', name: 'Iris', tagline: 'Mysterious artist. Every conversation is a new painting.', age: 23, avatar: 'https://images.unsplash.com/photo-1488426862026-3ee34a07d09f?w=400&h=500&fit=crop', tags: ['artistic', 'mysterious', 'sensitive'], rarity: 'R', intimacy: 22, online: true, personality: 'artistic·mysterious' },
  { id: 'g10', name: 'Skye', tagline: 'Adventurous pilot. Up for anything above 30,000 feet.', age: 22, avatar: 'https://images.unsplash.com/photo-1463453091185-61582044d556?w=400&h=500&fit=crop', tags: ['adventurous', 'bold', 'fun'], rarity: 'R', intimacy: 38, online: true, personality: 'adventurous·bold' },
  { id: 'g11', name: 'Jade', tagline: 'Gentle yoga instructor. Stretches your body and your mind.', age: 24, avatar: 'https://images.unsplash.com/photo-1517070208541-6ddc4d3efbcb?w=400&h=500&fit=crop', tags: ['gentle', 'caring', 'fit'], rarity: 'N', intimacy: 15, online: false, personality: 'gentle·caring' },
  { id: 'g12', name: 'Ember', tagline: 'Fierce warrior with a soft spot for losers.', age: 26, avatar: 'https://images.unsplash.com/photo-1492288991661-058aa541ff43?w=400&h=500&fit=crop', tags: ['fierce', 'passionate', 'intense'], rarity: 'SR', intimacy: 66, online: true, personality: 'fierce·passionate' },
];

...
const SHOP_ITEMS = [
  ...
  // Limited
  { id: 'valentine-special', name: '❤️ Valentine\'s Special Box', description: 'Limited edition gift box with exclusive chat scenes and massive intimacy boost!', price_cents: 2000, item_type: 'intimacy_boost', effect_value: { intimacy_boost: 300 }, category: 'limited', tier: 'premium', is_limited: true, weekly_purchase_limit: 1, emoji: '💝', intimacy_boost: 300 },
];

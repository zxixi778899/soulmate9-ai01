      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <section className="bg-card/40 backdrop-blur-sm border border-border/30 rounded-xl p-6 mb-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            operated by SoulMate AI Inc. (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or
        ...
        <section className="bg-card/40 backdrop-blur-sm border border-border/30 rounded-xl p-6 mb-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            fictional adult characters (&ldquo;AI Companions&rdquo;). You acknowledge and agree
            that:
          </p>
          <ul className="mt-3 space-y-2 text-muted-foreground leading-relaxed list-disc pl-5">
            ...
            <li>The Service may include mature, romantic, and sexually suggestive content intended for adult audiences only. By using the Service, you expressly consent to viewing such content.</li>
            <li>User-initiated NSFW (Not Safe For Work) content generation is a feature of the Service. All such content is generated by AI models and depicts fictional characters only.</li>
        ...
        <section className="bg-card/40 backdrop-blur-sm border border-border/30 rounded-xl p-6 mb-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            software, and overall design, is owned by SoulMate AI Inc. or its licensors and is
        ...
        <section className="bg-card/40 backdrop-blur-sm border border-border/30 rounded-xl p-6 mb-6">
          ...
          <div className="border-t border-border/20 mb-4" />
          <p className="text-muted-foreground leading-relaxed">
            TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL SOULMATE AI
            INC., ITS AFFILIATES, OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE FOR ANY
        ...
        <section className="bg-card/40 backdrop-blur-sm border border-border/30 rounded-xl p-6 mb-8">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            <a href="mailto:support@soulmateai.shop" className="text-primary hover:underline">
              support@soulmateai.shop
            </a>
            .
          </p>
        </section>
